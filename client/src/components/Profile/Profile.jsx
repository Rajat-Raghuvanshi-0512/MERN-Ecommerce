                ...
                loading ? (
                    ...
                    (
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-md-6 my-3 p-3 d-flex align-items-center justify-content-center flex-column">
                                ...
                                <div className="col-md-6 p-3 my-2 details">
                                    <h2 className='border-bottom text-center fw-bold'>USER DETAILS</h2>
                                    <div className='p-2 pt-5'>
                                        <h4>Name:</h4>
                                        <p className=' text-success px-3 opacity-75'>{user.name}</p>
                                    </div>
                                    <div className='p-2'>
                                        <h4>E-mail:</h4>
                                        <p className=' text-success px-3 opacity-75'>{user.email}</p>
                                    </div>
                                    <div className='p-2'>
                                        <h4>Joined On:</h4>
                                        <p className=' text-success px-3 opacity-75'>{user.createdAt && user.createdAt.substr(0, 10)}</p>
                                    </div>
