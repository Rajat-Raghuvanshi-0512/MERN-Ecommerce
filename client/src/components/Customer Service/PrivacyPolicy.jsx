...
const PrivacyPolicy = () => {
    return (
        <div className='container'>
            <h1 className="text-center fw-bold mt-5 mb-4">Privacy Policy</h1>
            <p>
            ...
            <h3 className='fw-bold my-3'>Interpretation and Definitions</h3>
            <h5 className='fw-bold opacity-75'>Interpretation</h5>
            <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            <h5 className='fw-bold opacity-75'>Definitions</h5>
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Shop Buddy, accessible from <a href="http://myshopbuddy.herokuapp.com/" rel="external nofollow noopener noreferrer" target="_blank">http://myshopbuddy.herokuapp.com/</a>
                    </p>
                </li>
                <li>
                    <p>
            ...
            <h3 className='fw-bold my-3'>Collecting and Using Your Personal Data</h3>
            <h4 className="my-4 fw-light text-center ">Types of Data Collected</h4>
            <h5 className="my-4 fw-bold ">Personal Data</h5>
            ...
            <h5 className="my-4 fw-bold">Usage Data</h5>
            ...
            <h5 className="my-4 fw-bold">Information from Third-Party Social Media Services</h5>
            <p>
            ...
            <h5 className="my-4 fw-bold">Tracking Technologies and Cookies</h5>
            ...
            <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies:
                <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" rel="noreferrer">Use of Cookies by Free Privacy Policy</a>.
            </p>
            ...
            <h3 className="my-3 fw-bold">Links to Other Websites</h3>
            <p>
            ...
            <h3 className="my-3 fw-bold">Changes to this Privacy Policy</h3>
            <p>
            ...
            <h3 className="my-3 fw-bold">Contact Us</h3>
