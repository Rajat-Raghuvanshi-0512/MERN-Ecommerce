...
import { mainContainerCss, headingCss, addMarginX, addMarginY, firstContainer, theme, lastContainer } from "./ObjectCss"
                ...
                loading ?
                    ...
                    <form method='post' onSubmit={registerUser}>
                        <Container sx={mainContainerCss}  >
                            ...
                            <Container>
                                <img src={require("../../images/register.png")} alt="register" style={{ maxWidth: "100%", maxHeight: '100%' }} />
